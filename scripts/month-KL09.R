...
met <- met_year(rs_q2_metadata, "KL", 2009)
# loop to create individual month data frames
for (month in unique(met$Month)) {
  df <- XY_month(rs_q2_metadata, "KL", 2009, month)
...
pdf(file = "/home/ahalhed/projects/def-cottenie/Microbiome/RedSquirrelMicrobiome/R-env/RedSquirrelMicrobiome/plots/core_KL2009_vp_mod1M.pdf")
# make plot
...
# save plot
pdf(file = "/home/ahalhed/projects/def-cottenie/Microbiome/RedSquirrelMicrobiome/R-env/RedSquirrelMicrobiome/plots/core_KL2009_step_envM.pdf")
# make plot
...
# save plot
pdf(file = "/home/ahalhed/projects/def-cottenie/Microbiome/RedSquirrelMicrobiome/R-env/RedSquirrelMicrobiome/plots/core_KL2009_step_spaceM.pdf")
# make plot
...
vp_mod1_list
# plot the partitioning
pdf(file = "/home/ahalhed/projects/def-cottenie/Microbiome/RedSquirrelMicrobiome/R-env/RedSquirrelMicrobiome/plots/nc_KL2009_vp_mod1M.pdf")
# make plot
# plotted in numerical order by month
lapply(vp_mod1_list, plot)
dev.off()
...
# save plot
pdf(file = "/home/ahalhed/projects/def-cottenie/Microbiome/RedSquirrelMicrobiome/R-env/RedSquirrelMicrobiome/plots/nc_KL2009_step_envM.pdf")
# make plot
lapply(step.env, plot)
dev.off()
...
# save plot
pdf(file = "/home/ahalhed/projects/def-cottenie/Microbiome/RedSquirrelMicrobiome/R-env/RedSquirrelMicrobiome/plots/nc_KL2009_step_spaceM.pdf")
# make plot
lapply(step.space, plot)
dev.off()
...
# remove objects to be replaced
rm(vdist,pbcd)
rm(commNC, abFrac, aFrac,abFrac0, step.env, pcnm_df, bcFrac, bcFrac0, step.space)
...
vp_mod1_list
# plot the partitioning
pdf(file = "/home/ahalhed/projects/def-cottenie/Microbiome/RedSquirrelMicrobiome/R-env/RedSquirrelMicrobiome/plots/KL2009_vp_mod1M.pdf")
# make plot
# plotted in numerical order by month
lapply(vp_mod1_list, plot)
dev.off()
...
# save plot
pdf(file = "/home/ahalhed/projects/def-cottenie/Microbiome/RedSquirrelMicrobiome/R-env/RedSquirrelMicrobiome/plots/KL2009_step_envM.pdf")
# make plot
lapply(step.env, plot)
dev.off()
...
# save plot
pdf(file = "/home/ahalhed/projects/def-cottenie/Microbiome/RedSquirrelMicrobiome/R-env/RedSquirrelMicrobiome/plots/KL2009_step_spaceM.pdf")
# make plot
lapply(step.space, plot)
dev.off()
...
# remove objects to be replaced
rm(vdist,pbcd)
rm(commFull, abFrac, aFrac,abFrac0, step.env, pcnm_df, bcFrac, bcFrac0, step.space)
